    ...
    <div className="space-y-8 md:space-y-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-3 md:gap-6">
        {[
          ...
          { icon: ShoppingBag, label: 'Total Units', value: '12', color: 'text-text-main', tooltip: 'Acquired artifacts' },
        ].map((stat, idx) => (
      ...
      >
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-lg font-black uppercase tracking-[0.2em] text-text-main">Recent Artifacts</h2>
          </div>
          <button 
